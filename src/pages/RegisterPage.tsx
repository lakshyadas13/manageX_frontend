    ...
    <div className="min-h-screen bg-[#f3f1ea] px-4 py-8">
      <div className="mx-auto flex min-h-[80vh] w-full max-w-6xl items-center justify-center">
        <div className="w-full max-w-md rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <h1 className="font-instrument-serif mt-3 text-4xl text-slate-900">Create account</h1>
          <p className="mt-2 text-sm text-slate-600">Start your personal ManageX workspace in seconds.</p>
